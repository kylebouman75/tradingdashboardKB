...
import type { ScreenshotLabel, TradeScreenshot } from '@/lib/trades'
import {
  Select,
  SelectContent,
  SelectItem,
...
export function ScreenshotGallery({
  ...
  editable?: boolean
  onDelete?: (screenshot: TradeScreenshot) => void
...
function ScreenshotThumbnail({
  ...
  React.useEffect(() => {
    ...
    console.log('[screenshot-gallery] src vlak voor render:', src)
  }, [src])
  ...
  async function handleError() {
    ...
    const signedUrl = await getSignedScreenshotUrl(supabase, screenshot.storage_url)
    if (signedUrl) {
      setSrc(signedUrl)
    }
  }
